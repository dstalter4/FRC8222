...
public final class Constants {
  ...
  public static final class Arm {
    ...
    public static final double kSoftLimitReverse = -1.55;
    ...
    public static final PIDGains kArmPositionGains = new PIDGains(0.5, 0.0, 0.0);
    ...
    public static final double kIntakePosition = -1.57;
  }
  ...
  public static final class ModuleConstants {
    ...
    public static final double kDrivingMotorReduction =
        (45.0 * 22) / (kDrivingMotorPinionTeeth * 14);
    ...
    public static final double kTurningMinOutput = -0.8;
    public static final double kTurningMaxOutput = 0.8;
